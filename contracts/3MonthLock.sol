...
contract LandTokenStake {
    ...
    mapping(address => bool) public isLockActive;
    mapping(address => uint) public wenUnlock;

    mapping(address => uint) public timeEntered; 
    uint lockPeriod = 7889229;
    ...
    function deposit(uint amount) public {
        ...
        if (isLockActive[msg.sender] == false){
            timeEntered[msg.sender] = block.timestamp;
            isLockActive[msg.sender] = true;
            wenUnlock[msg.sender] = timeEntered[msg.sender] + lockPeriod; 
        }
    ...
    function withdraw(uint withdrawAmt) public {
        ...
        require(block.timestamp > wenUnlock[msg.sender], "Funds still locked");
